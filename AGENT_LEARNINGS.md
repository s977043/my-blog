...
- SVG 画像は事前に PNG 変換が必要。`cairosvg` が利用可能（`pip3 install --break-system-packages cairosvg`）:
  ```python
  import cairosvg
  cairosvg.svg2png(url="path/to/file.svg", write_to="articles_note/assets/file.png", scale=2)
  ```
