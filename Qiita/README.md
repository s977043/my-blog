...
- **Qiita**（本ディレクトリ）: 検索入口＋実務 Tips・トラブルシュート（鮮度重視・AI生成コンテンツガイドライン遵守）
- **Zenn** (`articles/`): 体系化された技術知識・逆引きリファレンス
- **note**: 一次体験・思想（体験談/振り返りは note の役割）

> 旧記述（Qiita=体験談/振り返り中心）は正本の 2025-2026 版に合わせ更新。
