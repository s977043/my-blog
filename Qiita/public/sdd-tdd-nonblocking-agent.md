...
:::note info
- 📕 [Zenn Book: AI にコードを書かせる前にやること — PlanGate 実践ガイド](https://zenn.dev/minewo/books/plangate-guide) - 本記事の「計画→実装→検証」を全9章で体系化した実践ガイドです。
- [Zenn: アジャイルでAI駆動開発をどう回すか — PlanGateの考え方とテンプレート](https://zenn.dev/minewo/articles/plangate-ai-coding-workflow) - 仕様とレビューのゲートをAIワークフローに置く実践例です。
- [Zenn: Next.js App Router時代のAI-driven TDD](https://zenn.dev/minewo/articles/ai-driven-tdd-nextjs) - テストを先に置いてAI実装を止めない方法を具体化しています。
- [PlanGate GitHub](https://github.com/s977043/plangate) / [River Reviewer GitHub](https://github.com/s977043/river-reviewer)
:::

> 本記事は [Zenn 版](https://zenn.dev/minewo/articles/sdd-tdd-nonblocking-agent) を Qiita 向けに再構成したものです。
