...
- デザインツールを Open Design（オープンソース・オープンフォーマットのデザイン基盤、ここでは Penpot）へ寄せるか検討している人
- その判断材料を「品質」の言葉で欲しいフロントエンドエンジニア・テックリード
- AI 実装に向く設計データの性質を整理したい人
...
![Open Designを品質ゲートへ接続する流れ](https://raw.githubusercontent.com/s977043/my-blog/main/images/open-design-design-quality/open-design-quality-flow.png)
