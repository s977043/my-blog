...
:::note info
本記事は、note に掲載した [AIコーディングの暴走を「仕組み」で止める — PlanGateという開発フロー](https://note.com/mine_unilabo/n/n3aae6b5467b9) と同じ PlanGate を題材に、Qiita 向けに「アジャイル運用にどう乗せるか」へ角度を変えて再構成したものです。
:::
