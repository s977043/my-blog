...
第 2 章（Why）と第 5 章（Verify & Scale）は、主張を補強する章です。とくに第 5 章には「**PlanGate なしでも使える原則**」と「守られたことの証明（Verify）」が入っており、ここを読まないと本書が「Plan 万能論」に見えかねません。最小ルートで読む場合も、第 5 章末の「PlanGate なしでも使える原則」節だけは併せて目を通すことを勧めます。
