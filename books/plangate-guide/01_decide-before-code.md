...
計画に何を書けばよいかは、PlanGate がゼロから考えたものではありません。中身を見ると、3 つの出どころがあります。

- **これまでのソフトウェア開発の知識**: 設計やテストについて、長く積み上がってきた知識
- **アジャイル開発の定石**: 実装の前に、なぜやるのかと何ができたら完了かをそろえる進め方
- **AI が正しく動くための知識**: AI に任せるようになってから、実際の失敗をもとに加わった知識

前の 2 つは、人間のチームでも昔から大事にされてきたものです。AI に任せるときは、ここに 3 つ目を足す必要があります。人間なら暗黙に確かめていることを、AI は確かめないことがあるからです。第 2 章でこの 3 つを整理し、第 3〜7 章で一つずつ具体的に見ていきます。
...
本書が時間をかけるのは 1〜3 です。1〜3 を固めるのは、4 の実行で判断に迷う場面を減らすためです（時間の短縮までは保証しません）。
...
|---|---|
| 第 2 章 | 計画に入れる 3 つの知識 |
| 第 3 章 | Why・スコープ・受入基準・完了の定義を決める（アジャイル由来） |
| 第 4 章 | 設計案・規模・テスト方針を決める（これまでの開発知識由来） |
| 第 5 章 | AI の前提を実測で確かめる |
| 第 6 章 | AI が決めてよい範囲と止まる条件を決める |
| 第 7 章 | 検証方法を実装の前に決める |
| 第 8 章 | 1 つの計画を通してレビューする |
| 第 9 章 | 骨組みで自分の計画を書く。ひとりで使う場合の最小構成と、チームで始める手順も |
| 第 10 章 | プラグインで計画のサイクルを回す |
| 付録 | つまずきやすい点 |

急ぐ場合は、第 1 章・第 5 章・第 8 章だけでも、PlanGate が何をしようとしているかはつかめます。すぐに自分の計画を書きたい場合は第 9 章の骨組みから始め、分からない欄があれば第 3〜7 章の該当する節に戻ってください。ひとりで使う場合は、第 9 章の「ひとりで使う場合」から読み始めてください。PlanGate を使わない場合でも、第 3〜7 章の内容は自分の計画づくりにそのまま持ち込めます。
