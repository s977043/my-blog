...
| 症状 | 見直す場所 |
|------|------------|
| 触ってよいファイルが止まる | plan.md の Files / Components to Touch |
| 触ってはいけない判定が広すぎる | PBI INPUT の `forbidden_files` |
| 承認済みなのに C-3 で止まる | `approvals/c3.json` と `plan_hash` |
| 検証済みなのに PR で止まる | V-1 の検証ログ / handoff.md |
