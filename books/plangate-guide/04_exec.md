...
`plan.md` を作らずに production code を編集しようとすれば、EH-1 が止めます。
...
> Next.js App Router を題材にした AI-driven TDD の具体的な最小ループは、本書とは別に詳しく書いた記事があります → [Next.js App Router 時代の AI-driven TDD](https://zenn.dev/)（※ Book 内では本文を抱えず外部記事へ送る）
