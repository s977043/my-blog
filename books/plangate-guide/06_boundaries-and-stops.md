...
```mermaid
flowchart TD
    A["前提が崩れた"] --> B{"計画を書き直すだけで<br/>進められるか？"}
    B -->|"はい"| C["計画を立て直す<br/>（再レビュー）"]
    B -->|"いいえ<br/>（人が決めることがある）"| D["人の判断を待つ"]
```

分け方の目安は、計画を書き直してレビューを受け直せば進められるか、それとも要件・不可逆な変更・権限のように人が決めることが含まれるかです。迷ったら、人の判断を待つ側に倒します。
