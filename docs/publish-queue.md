...
| 10 | **2026-05-23（土）08:00 JST 以降** | zenn | `articles/river-reviewer-v033-improvement-loop.md` | 公開済記事の **再デプロイ** | published:true は既設定。release/zenn に空 commit or 該当ファイル touch して再 push、5/22 06:28 から 24h 経過後（5/23 06:28 JST 以降）に実行 |
...
- 2026-05-22 zenn river-reviewer-v033-improvement-loop **🚨 rate-limit hit でデプロイ拒否** — main / release/zenn ともマージ済（PR #295/#296）だが Zenn 側で「投稿数の上限に達したため」未公開。再デプロイ必要（下記 Queue #10 参照）
