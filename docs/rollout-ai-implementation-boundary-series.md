...
| plangate-ai-agent-governance | 計測・公開済 | 止めた回数を数字で見る運用 | "AI 開発 メトリクス" | 公開済 id:93027e02e962ec327c2f |
...
- 公開順（根拠: 問題提起を先・詳細を後。Codex/Gemini 合意）:
  ...
  3. plangate（公開済・受け側、リンク確立済 https://qiita.com/s977043/items/93027e02e962ec327c2f）
