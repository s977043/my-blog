...
今回は、そこで感じた違和感を入口に、両者で何をどう定義し直したのかを紹介します。
...
Discoveryでは、どの課題や価値仮説を確かめるべきかを探る。Deliveryでは、現時点で価値があると判断した変更を、プロダクトとして正しく届ける。
...
同じチームが両方を行き来し、Deliveryで新しい不確実性が見つかればDiscoveryへ戻る。Discoveryで十分な根拠が得られれば、Deliveryへ進む判断ができる。
