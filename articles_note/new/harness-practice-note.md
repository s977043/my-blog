...
この境界を意識するきっかけの1つが、[Darwin Gödel Machine（DGM）の論文](https://arxiv.org/abs/2505.22954)でした。DGMは自分自身のコードを書き換えながら改善するエージェントで、SWE-benchでは20.0%から50.0%、Polyglotでは14.2%から30.7%へ性能を伸ばしています。
