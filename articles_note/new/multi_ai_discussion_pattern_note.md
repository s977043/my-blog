...
業界事例として妥当でも、自分の規模・段階・利用者層に合うとは限りません。引用 URL がついていると、つい「これは正しい」と思ってしまう。けれど引用が正しいことと、自分の現場に合うかは別の問題です。
...
この体験を、そのまま手順に落とすとこうなります。AI が 1 種類しかなくても、役を切り替えれば再現できます。

1. **役を決める**：1 つの AI に「今は賛成して詰める役」と最初に宣言してから相談を始める
2. **賛成の段階で詰める**：方針に沿って設計の穴を埋めきる。ここでは前提を疑わない
3. **段階を変えて反証させる**：別の対話として「さっきの結論を、現実制約を理由に批判して」と頼む。制約（規模・人数・利用者）を先に渡すのがコツ
4. **最後に「誰のため」を入れる**：「初めて使う人の視点で見て」と頼み、結論を点検する

特に効くのは 4 番です。これがないと、1〜3 を完璧に回しても後半で前提が崩れます。1 種類の AI でも、段階を分けて役を切り替えるだけで「賛成しか返ってこない」状態からは抜けられます。
