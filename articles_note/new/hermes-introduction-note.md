# 個人開発でAIエージェントチームを作るために、ヘルメスを導入した

> 区分: 個人

ヘルメスを導入した話を、いったんドラフトとして整理しておきます。

まだ最終稿ではありません。導入時期、実際の運用フロー、具体的な成果は、あとで事実に合わせて差し込む前提です。

この記事で書きたいことは、会社に新しいAIツールを入れた話ではありません。

個人開発の中で、複数のAIエージェントに仕事を渡していくとき、どうやって「自分ひとりの作業」から「AIエージェントチームの運用」に変えていくか。

そのための入口として、ヘルメスを導入したという話です。
...
ヘルメスは、この問題に対して「AIに何を頼むか」を置いておく場所になるのではないか。
