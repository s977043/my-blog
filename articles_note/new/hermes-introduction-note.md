# 個人開発でAIエージェントチームを作るために、Hermesを「依頼窓口」として導入し始めた
...
そう感じたので、個人開発のAIエージェント運用を整える入口として、Hermesを導入し始めました。

この記事でいうHermesは、個人開発で複数のAIエージェントに依頼を出すための窓口として使おうとしている仕組みです。

ただし、ここで書きたいのはHermesの機能一覧ではありません。

むしろ、チャットに流れがちな依頼、前提、制約、判断理由を、あとから読み返せる形で残すための運用設計として整理したいと思っています。

## Hermesを「万能な自動化ツール」として見ない

最初に、期待値を間違えないようにしておきたいです。

Hermesを入れたからといって、個人開発がいきなり自動で回るわけではありません。
...
## Hermesに期待しているのは「AIエージェントチームへの依頼窓口」
...
Hermesに置きたい依頼は、もう少し仕事として扱える形です。
...
Hermesを入れる意味は、この「依頼の型」を外に出すところにあると考えています。
...
Hermesでやりたいのは、この「頭の中だけで回していた司令塔」を少し外に出すことです。
...
Hermesを個人開発に入れるなら、最初に大きな自動化を狙わないほうがよいと思っています。
...
Hermes導入の最初の依頼は、小さく始めるのがよさそうです。
...
## Hermes導入は、AI活用ではなく個人開発の運用設計

ここまで考えると、Hermes導入はAI活用というより、個人開発の運用設計に近いです。
...
Hermes導入でやりたいのは、AIにもっと多くの作業を丸投げすることではありません。
