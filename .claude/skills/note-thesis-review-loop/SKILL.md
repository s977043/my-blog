...
2. **Logic Editor**
   - 導入 → 問い → 根拠 → 具体例 → 結論の因果
   - H2だけを読んで読者が追うストーリーが分かるか
   - H2が論点カタログになっていないか
   - 同じ役割の並列テーマを上位の意味で束ね、必要ならH3へ下げられないか
   - 同じ主張の重複
   - 章順の不自然さ
...
- 冒頭で問いと結論を早める
- H2を増やして整理したつもりにならず、読者が追う軸へ束ねる
- 重複セクションを統合する
- 主題から遠い背景説明を圧縮する
- 外部情報を「主役」にせず、筆者の主張を支える位置へ置く
...
2. **First-time Reader**
   - 前記事を読んでいなくても理解できるか
   - 専門用語が多すぎないか
   - 対象読者が知らない可能性のある用語は初出で一度だけ説明されているか
   - 同じ用語の括弧説明が複数箇所で繰り返されていないか
   - 英語名詞や独自概念が連続し、意味を推測しないと読めない箇所がないか
...
- Loop 3では原則として新しい論点を足さず、密度を下げる
- 終盤の重複を統合する
- 同じLoop / 図 / 主張の再掲を削る
- 一度説明した専門語の再説明を削る
- 派生概念は削除・短縮・次記事へ送る
- 終盤の主結論を1つにし、次記事の予告は現在の記事の結論より短くする
- タイトルと最後の一文を呼応させる
