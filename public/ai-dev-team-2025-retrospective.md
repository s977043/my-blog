...
ポイントは、会話ではなくファイルに残すことです。

- `pbi-input.md`: なぜやるか、何をやるか、何をやらないか
- `plan.md`: 変更方針、手順、リスク
- `test-cases.md`: 先に確認したい振る舞い
- `review-self.md`: AI自身に見直させる観点
- `review-external.md`: 人間や別AIが見る観点
- `status.md`: いまどこまで進んでいるか

この形にすると、AIとの協働が「お願い」から「運用」に変わります。
