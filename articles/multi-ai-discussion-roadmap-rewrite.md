...
:::message
**想定読者**: Claude Code / Codex CLI / Gemini CLI のいずれかを触ったことがあり、AI エージェントを複数併用して設計判断を回したい OSS 開発者・プロダクト設計者

**前提**: 個人 OSS のロードマップ策定を題材にしていますが、議論の組み立て方は他の設計判断にも応用できる前提で書いています
:::
...
:::message
- [AIコーディングを「比較で改善」できる土台にする：PlanGate v8.6.0のMetrics v1とGovernance](https://zenn.dev/minewo/articles/plangate-v86-hook-enforcement) - この議論で組み替えたロードマップの、直前の到達点（v8.6.0）です。
:::
