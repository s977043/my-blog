...
本記事は「契約をどう持つか」を扱いました。続編で、その契約に乗せる入口とツール選定を整理しています。

- 入口ドキュメントの整え方：[DESIGN.md 導入ガイド: AI実装のための入口・契約・検証をどう整えるか](https://zenn.dev/minewo/articles/design-md-guide-and-adoption-log)
- ツール選定（Open Design）の論拠：[Open Designでデザイン品質を上げる：Penpot契約運用とDESIGN.mdの続編](https://zenn.dev/minewo/articles/open-design-design-quality)
