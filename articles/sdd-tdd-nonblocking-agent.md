...
- **River Reviewer**：PR差分に対してレビュー観点を再利用できる形で適用するAIレビュー運用フレームワーク
...
- **CI/CD 統合**：テストが合格していなければ自動的に進まない仕組み
...
- [note: 二層ドキュメント × 複数 AI で回す速度改善](https://note.com/mine_unilabo/n/n95c4538af945)
- [note: AITDD 実践録（Claude Code / Gemini CLI）](https://note.com/mine_unilabo/n/nc62d478194d3)
...
:::message
- [アジャイルでAI駆動開発をどう回すか: PlanGateの考え方とテンプレート](https://zenn.dev/minewo/articles/plangate-ai-coding-workflow) - 仕様とレビューのゲートをAIワークフローに置く実践例です。
- [Next.js App Router時代のAI-driven TDD：実践的な最小ループと具体的な実装パターン](https://zenn.dev/minewo/articles/ai-driven-tdd-nextjs) - テストを先に置いてAI実装を止めない方法を具体化しています。
- [GitHubにAI開発チームメイトを迎えよう — Gemini CLIでレビュー時間を1/3に短縮する方法](https://zenn.dev/minewo/articles/gemini-cli-github-actions-zenn-article) - レビュー・Issue・テスト生成を自動化する運用です。
:::
