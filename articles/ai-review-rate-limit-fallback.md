...
<!-- ✍️要・実体験ヒアリング2：あなたが踏んだレート制限/詰まりの具体例があれば1つ（ツール名・症状）。生々しいほど刺さります。 -->
...
<!-- ✍️要・実体験ヒアリング3：あなたの環境で L1/L2/L3 に当たるものは何か（例: L1=Claude Code subagent, L2=Gemini Code Assist bot, L3=Codex CLI）。具体名があると再現性が出ます。 -->
